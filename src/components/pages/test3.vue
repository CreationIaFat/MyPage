...
<main class="container">
  <div class="row rounded bg-dark mb-4 appear-element-case-minimum">
    ...
    <div class="col-md-4 offset-md-1 clear-element">
      <img src="/src/assets/Toyamayoko.jpg" width="428" height="350">
    </div>
  </div>
  ...
  <div class="row d-flex justify-content-around">
    <div class="col-md-6 row">
      ...
      <div class="col-md content_area">
        <img src="/src/assets/bookAndCofee.png" height="272" width="330" class="img">
      </div>
    </div>
    <div class="col-md-6 row">
     <postCard class="col" :summary="'Outdoor  hobby'" :title="'Frestyle Fottball'" p-none />
      <div class="col-md content_area">
        <video alt="freestyle"  autoplay  loop muted src="/src/assets/VID_36081025_093034_176.mp4" height="272" width="330" class="img"/>
      </div>
    </div>
  </div>
  <div class="row">
